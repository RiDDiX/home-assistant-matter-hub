...
Alpha is ahead of Stable (v2.0.57): old backups are deleted again when a shutdown backup gets cut off, and the backup settings are checked ([#483](https://github.com/RiDDiX/home-assistant-matter-hub/issues/483)) (alpha.899); the network check points out a service holding port 80 ([#449](https://github.com/RiDDiX/home-assistant-matter-hub/issues/449)) and lights can be exposed as an outlet so Apple Home shows their wattage ([#484](https://github.com/RiDDiX/home-assistant-matter-hub/issues/484)) (alpha.900). Standalone Devices graduated to Stable in v2.0.47, see [Standalone Devices](../getting-started/standalone-devices.md).
