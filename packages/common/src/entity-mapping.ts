...
export interface EntityMappingConfig {
  ...
  /** Appliance state sensor on the same device, found automatically (#486). */
 ...
 * picker can warn before you pick a type your controller ignores. Checked
 * 2026-09: Apple from its chipplugin-protocol-map plist (#410), Google and Alexa
 * from their device pages, Aqara from its Supported Matter Device Type List,
 * SmartThings from the matterGeneric fingerprints of its Edge drivers.
 */
...
> = {
  ...
  humidifier_dehumidifier: {
    ...
    aqara: "partial",
    smartthings: "partial",
    note: "Shows up as a fan, there is no Matter humidifier type.",
  },
  dishwasher: {
    apple: "unknown",
    google: "yes",
    ...
    aqara: "yes",
    smartthings: "yes",
    note: "iOS 27 knows the type, but it's not confirmed that Apple Home shows it. Alexa wants Dishwasher Mode and Temperature Control, which HAMH doesn't expose.",
  },
  laundry_washer: {
    apple: "unknown",
    google: "yes",
  ...
  laundry_dryer: {
    ...
    aqara: "yes",
    smartthings: "yes",
    note: "iOS 27 knows the type, but it's not confirmed that Apple Home shows it. Google only has it in its developer API so far.",
  },
  speaker: {
    apple: "no",
    google: "yes",
  ...
  formaldehyde_sensor: {
    ...
    aqara: "yes",
    smartthings: "yes",
    note: "Apple shows the air quality, not this reading.",
  },
  radon_sensor: {
    apple: "partial",
    google: "yes",
  ...
  electrical_meter: {
    ...
    aqara: "unknown",
    smartthings: "unknown",
    note: "Google Home shows an ElectricalMeter (0x0514). Apple and Alexa do not show standalone power or energy.",
  },
  electrical_sensor: {
    apple: "no",
    google: "no",
  ...
  electrical_utility_meter: {
    ...
    aqara: "unknown",
    smartthings: "unknown",
    note: "Matter 1.4 ElectricalUtilityMeter (0x0511) with MeterIdentification, plus the same measurement clusters as Electrical Meter. Google Home lists it.",
  },
  solar_power: {
    apple: "no",
    google: "no",
    ...
    aqara: "yes",
    smartthings: "yes",
    note: "SolarPower (0x0017) for generation. Aqara and SmartThings show it standalone.",
  },
  battery_storage: {
    apple: "no",
    google: "no",
  ...
  evse: {
    ...
    aqara: "yes",
    smartthings: "yes",
    note: "HA, Aqara and SmartThings render EnergyEvse. Bridged EVSE can break Alexa device recognition, keep it off Alexa bridges.",
  },
  contact_sensor: {
    apple: "yes",
    google: "yes",
  ...
  water_heater_management: {
    ...
    aqara: "yes",
    smartthings: "yes",
    note: "Matter 1.4 Water Heater (0x050F) with WaterHeaterManagement Boost/CancelBoost. Aqara and SmartThings list it.",
  },
  generic_switch: {
    apple: "partial",
    google: "no",
  ...
  doorbell: {
    ...
    aqara: "no",
    smartthings: "unknown",
    note: "Experimental Matter 1.4 Doorbell (0x148). Google Home lists it; other controllers don't know the type and fall back to the plain Switch cluster, if they show it at all.",
  },
  smoke_co_alarm: {
    apple: "yes",
    google: "yes",
